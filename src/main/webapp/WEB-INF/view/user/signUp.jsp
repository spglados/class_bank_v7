...
<div class="col-sm-8">
	...
	<form action="/user/sign-up" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="fullname">fullname:</label> <input type="text" class="form-control" placeholder="Enter fullname" id="fullname" name="fullname" value="검객">
		</div>
		...
		<div>
			<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a32223656961a783cd0766d3ce3c9195&redirect_uri=http://localhost:8080/user/kakao">
